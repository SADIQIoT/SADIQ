...
public class SwitchPortBandwidth {
	...
	private U64 rxValue;
	private U64 txValue;
	private U64 txDroppedPkts;
	
	private SwitchPortBandwidth() {}
	private SwitchPortBandwidth(DatapathId d, OFPort p, U64 rx, U64 tx, U64 rxValue, U64 txValue, U64 txDroppedPkts) {
		id = d;
		pt = p;
		this.rx = rx;
		this.tx = tx;
		...
		this.txDroppedPkts=txDroppedPkts;
	}
	
	public static SwitchPortBandwidth of(DatapathId d, OFPort p, U64 rx, U64 tx, U64 rxValue, U64 txValue, U64 txDroppedPkts) {
		if (d == null) {
		...
		if (txDroppedPkts == null) {
			throw new IllegalArgumentException("txDroppedPkts cannot be null");
		}
		return new SwitchPortBandwidth(d, p, rx, tx, rxValue, txValue,txDroppedPkts);
	}
	...
	public U64 getDroppedPkts() {
		return txDroppedPkts;
	}
